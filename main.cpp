...
int main()
{
	...
	Font myfont;
	myfont.loadFromFile("myfonts/Xenowort.ttf");
	...
	while (app.isOpen())
	{
		...
		//Game level
		if (score>15 && score<25) { gameSpeed = 0.4; }
		if (score>25 && score<35) { gameSpeed = 0.5; }
		if (score>35 && score<50) { gameSpeed = 0.6; }
		if (score>50 && score<70) { gameSpeed = 0.7; }
		if (score>70 && score<100) { gameSpeed = 0.8; }
		if (score>70 && score<100) { gameSpeed = 0.9; }
		if (score>70 && score<100) { gameSpeed = 1.1; }
		if (score>70 && score<100) { gameSpeed = 1.2; }
